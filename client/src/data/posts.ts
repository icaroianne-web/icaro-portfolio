...
export const INITIAL_POSTS: BlogPost[] = [
  {
    ...
    title: "Plano Diretor de Comunicação: Como parar de apagar incêndios e assumir o controle da sua narrativa",
    excerpt: "Conheça a Bússola de Prioridade (Método UTIO) para separar o que é urgente, o que exige timing oportuno, o que é indispensável e o que é opcional na sua empresa.",
    ...
    tags: ["Plano Diretor", "Método UTIO", "Estratégia", "Comunicação Corporativa"],
...
## A Solução: O Método UTIO (Bússola de Prioridade)

Para resolver esse caos operacional, desenvolvemos o **Método UTIO** dentro do nosso **Plano Diretor de Comunicação**. Essa metodologia organiza suas decisões de comunicação em quatro direcionais bem definidos:
...
> "Quando tudo é prioridade, nada é prioridade. A Bússola UTIO devolve a clareza estratégica ao líder."

---

## Como Começar o Seu Plano Diretor

O Plano Diretor não é um PDF estático de 100 páginas que fica gavetado. É um manual vivo de tomada de decisão que acompanha sua equipe ou agência parceira.

Se a sua empresa precisa de clareza imediata e de uma arquitetura editorial robusta, conheça os detalhes do nosso **Plano Diretor de Comunicação**.
    `,
  },
  {
    id: "2",
    slug: "marca-viva-branding-presenca-digital-pme",
    title: "Marca Viva: Por que seu site e sua identidade visual precisam falar a mesma língua",
    ...
    tags: ["Branding", "Marca Viva", "UX Design", "Presença Digital"],
...
O conceito de **Marca Viva** nasce da premissa de que a sua identidade é um organismo contínuo. Ela se desdobra desde o conceito institucional até os micro-textos (UX Writing) e botões de chamada no site.

---

## Os 3 Pilares de uma Marca Viva
...
Se o seu site ou a sua marca visual parecem desalinhados do nível real do seu produto, o processo **Marca Viva** reconstrói a sua autoridade do posicionamento à experiência web.
    `,
  },
  {
    id: "3",
