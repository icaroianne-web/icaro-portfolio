...
export default function HeroSection() {
  ...
  return (
    <section id="hero" ref={containerRef} className="relative h-[300vh]">
      <div className="sticky top-0 h-screen w-full flex items-center overflow-hidden">
        ...
        >
          <img
            src={HERO_BG}
            alt=""
            className="absolute inset-0 w-full h-full object-cover scale-[1.15] opacity-40 mix-blend-screen"
            loading="eager"
          />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center min-h-[80vh]">
            ...
            >
              <div className="relative w-full max-w-[340px] sm:max-w-[390px] lg:w-[410px] lg:max-w-[410px] mt-8 lg:mt-0">
                ...
                {/* Box da Animação */}
                <div className="relative overflow-hidden w-full aspect-[0.76] lg:h-[540px] bg-transparent z-10 flex items-center justify-center">
